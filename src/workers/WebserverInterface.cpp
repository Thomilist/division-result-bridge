...
namespace divi
{
    WebserverInterface::WebserverInterface(Settings* a_settings)
        : Loggable(Helpers::loggableWebserverInterface())
        , settings(a_settings)
    {
    ...
    cpr::Response WebserverInterface::create()
    {
    ...
    cpr::Response WebserverInterface::updateResults(const std::vector<ResultPackage>* a_results)
    {
        QJsonObject json;
        json[getMetadataAlias()] = getMetadataAsBase64String();
