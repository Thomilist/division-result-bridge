...
{#if release && meta && meta.assets[0]}
    <div class="latest-release">
        ...
        <a href="{release.assets[0].download_link}" class="download-latest-button">
        ...
        <div class="download-latest-details">
            <div>
                {@html $t("page.download.latest.details.version", {values:{
            ...
            <div>
                {@html $t("page.download.latest.details.file", {values:{
